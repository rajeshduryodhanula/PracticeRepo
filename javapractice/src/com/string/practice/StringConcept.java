...
public class StringConcept {
	...
	public static void main(String[] args) {
		...
		/*
		 * What is String? - String is a class in Java that represents a sequence of
		 * characters. - Strings are immutable (once created, they cannot be modified).
		 * - Strings can be created in two ways: 1) Using String literal 2) Using new
		 * keyword
		 */
	...
	static void demonstrateStringBuilderOperations(String companyName) {
		...
		String reversedCompanyName = new StringBuilder(companyName).reverse().toString();
		...
		System.out.println("Character count including spaces: " + companyName.length());

		// Count characters excluding spaces
		int characterCountWithoutSpaces = companyName.replace(" ", "").length();
		System.out.println("Character count excluding spaces: " + characterCountWithoutSpaces);
